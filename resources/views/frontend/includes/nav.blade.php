...
<img src="{{asset('assets/images/LOGO_-_Aramco_2-removebg-preview.png')}}" class="logo-light" alt="logo" width="6%">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            @guest
                <li class="nav-item"><a href="{{route('frontend.auth.adminPanalSE')}}" class="nav-link {{ active_class(Route::is('frontend.auth.login')) }}">@lang('navs.frontend.login')</a></li>
