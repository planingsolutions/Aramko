                    ...
                    <table id="Main_section" class="table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th>{{ trans('labels.backend.access.Home.aboutsec1.Projectdes') }}</th>
...
<!-- Description -->
                <div class="form-group">
                    <label for="Description" class="col-sm-12 control-label">{{ trans('labels.backend.access.Home.aboutsec1.Projectdes') }}</label>
                    <div class="col-sm-12">
