    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-5">
                ...
                @lang('labels.backend.access.Home.educational and administrative facilities') <small class="text-muted">{{ __('labels.backend.access.Home.Mainsectionf.active') }}</small>
                </h4>
            </div>
            <!--col-->
        </div>
