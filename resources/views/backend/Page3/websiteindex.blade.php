...
<!-- address -->
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="address" name="address" placeholder="{{trans('forms.Main.Placeholder.Tittle')}}" maxlength="255" required>
                    </div>
...
<!-- phone -->
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="number" class="form-control" id="phone" name="phone" placeholder="{{trans('forms.Main.Placeholder.Tittle')}}" maxlength="255" required>
                    </div>
