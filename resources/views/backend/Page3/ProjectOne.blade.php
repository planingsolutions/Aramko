    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-5">
                ...
                @lang('labels.backend.access.Home.fuel stations') <small class="text-muted">{{ __('labels.backend.access.Home.Mainsectionf.active') }}</small>
                </h4>
            </div>
            <!--col-->
        </div>
...
<!-- Project Owner -->
<div class="form-group">
                    <label for="Tittle" class="col-sm-12 control-label">{{__('translation.Project Owner')}}</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="PO" name="PO" placeholder="{{trans('forms.Main.Placeholder.Tittle')}}" maxlength="255" required>
                    </div>
...
// Edit-function
    function editFunc(id){
        ...
        $.ajax({
            type:"POST",
            url: "{{url('admin/Edit-fuelstations')}}",
            data:{id:id},
            dataType:'json',
...
function deleteFunc(id){
    ...
    $.ajax({
    type:"POST",
    url: "{{ url('admin/Delete-fuelstations') }}",
    data: { id: id },
    dataType: 'json',
    success: function(res){
...
// submit Button Function
    $('#CompanyForm').submit(function(e) {
            ...
            $.ajax({
            type:'POST',
            url: "{{ url('admin/Store-fuelstations')}}",
            data: formData,
            cache:false,
            contentType: false,
            processData: false,
