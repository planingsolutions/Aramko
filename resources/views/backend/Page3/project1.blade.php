      ...
      @endif
                <div class="table-responsive">
                    <table id="Main_section" class="table">
                        <thead>
                            <tr>
                                <th>{{ trans('labels.backend.access.Home.aboutsec1.Tittle') }}</th>
                                <th>{{ trans('labels.backend.access.Home.aboutsec1.MainImg') }}</th>
...
<!-- Tittle -->
                <div class="form-group">
                    <label for="Tittle" class="col-sm-12 control-label">{{ trans('labels.backend.access.Home.aboutsec1.Tittle') }}</label>
                    <div class="col-sm-12">
...
<!-- MainImg -->
<div class="form-group">
                    <label for="Images" class="col-sm-12 control-label">{{ trans('labels.backend.access.Home.aboutsec1.MainImg') }}</label>
                    <div class="col-sm-12">
