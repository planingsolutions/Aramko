        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('labels.backend.access.Home.Section2-Lists') }} <small class="text-muted">{{ __('labels.backend.access.Home.Mainsectionf.active') }}</small>
                </h4>
            </div>
            <!--col-->
        </div>
...
<!-- Tittle -->
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="list" name="list" placeholder="{{trans('forms.Main.Placeholder.Tittle')}}" maxlength="255" required>
                    </div>
...
<script>
  ...
  $('#Main_section').DataTable({
        processing: false,
        serverSide: true,
        ajax: "{{ url('admin/aboutuslists') }}",
        columns: [

        { data: 'id', name: 'id' },
        { data: 'list.'+lang, name: 'list' },
