...
class ProjectFourController extends Controller
{
     /**
    ...
    * @return ViewResponse
    */
    public function showProject4(MainsectionRequest $request)
    {
            $query=Projects::select('id','Tittle','Images','Location','updated_at')->where('section_id', 24);
            if(request()->ajax()) {
                return datatables()->of($query)
                ->addColumn('actions', 'Button.projectfour-action')
                ->rawColumns(['actions'])
                ->addIndexColumn()
                ->make(true);
            }
            return view('backend.Page3.ProjectFour');  
    }

    
   public function createProject4(Request $request)
   {
   ...
   public function storeProject4(Request $request)
   { 
   ...
   public function editProject4(Request $request)
   {   
   ...
   public function destroyProject4(Request $request)
   {
