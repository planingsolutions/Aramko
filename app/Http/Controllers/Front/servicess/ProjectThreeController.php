...
class ProjectThreeController extends Controller
{
     /**
    ...
    * @return ViewResponse
    */
    public function showmedicalfacilities(MainsectionRequest $request)
    {
            $query=Projects::select('id','Tittle','Images','Location','updated_at')->where('section_id', 22);
            if(request()->ajax()) {
                return datatables()->of($query)
                ->addColumn('actions', 'Button.projectthree-action')
                ->rawColumns(['actions'])
                ->addIndexColumn()
                ->make(true);
            }
            return view('backend.Page3.ProjectThree');  
    }

    
   public function createmedicalfacilities(Request $request)
   {
   ...
   public function storemedicalfacilities(Request $request)
   { 
   ...
   public function editmedicalfacilities(Request $request)
   {   
   ...
   public function destroymedicalfacilities(Request $request)
   {
